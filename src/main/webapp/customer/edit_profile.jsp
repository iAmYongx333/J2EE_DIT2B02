...
<head>
  ...
  <%
    ...
    // Password messages from servlet
        ...
        <div class="border-t border-[#e4dfd6] pt-5">
          <form method="post"
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <div class="space-y-1">
                <label for="name"
                       class="profile-label block text-[11px] uppercase text-slate-500">
                  Full name
                </label>
                <input type="text"
                       id="name"
                  ...
                  <div class="dropdown-list">
                    ...
                    %>
                      <div class="dropdown-item"
                           data-id="<%= c.getId() %>"
                           data-code="<%= c.getCountryCode() %>"
                           data-name="<%= c.getCountryName() %>"
                           data-image="<%= c.getFlagImage() %>">
                        <img src="<%= request.getContextPath() %>/images/flags/<%= c.getFlagImage() %>"
                             alt="<%= c.getCountryName() %>"
                             width="20"
